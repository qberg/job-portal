...
- **Locale vocab is declared**: Locale vocab codes are declared inline in locales.ts. (codes `en`/`ta`; default `en` = Lingui `sourceLocale`). Must match the DB `locale` table codes.
